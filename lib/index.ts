...
import {
  compactIdToOutpointBytesAndHex,
  isAtomicalId,
...
export {
  buildAtomicalsFileMapFromRawTx,
  hexifyObjectWithUtf8,
  isValidRealmName,
  isValidSubRealmName,
} from "./utils/atomical-format-helpers";
...
export class Atomicals implements APIInterface {
  ...
  static async createDmintItemManifests(
    folderName: string,
    output: string
  ): Promise<CommandResultInterface> {
    try {
      const command: CommandInterface = new CreateDmintItemManifestsCommand(
        folderName,
        output
      );
  ...
  static async createDmint(
    folderName: string,
    mintHeight: number,
    bitworkc: string
  ): Promise<CommandResultInterface> {
    try {
      const command: CommandInterface = new CreateDmintCommand(
        folderName,
        mintHeight,
        bitworkc
      );
  ...
  static async renderPreviews(filesmap: FileMap, body: boolean): Promise<any> {
    try {
      const command: CommandInterface = new RenderPreviewsCommand(
        filesmap,
        body
      );
      return command.run();
    ...
    const traitsArray = [
      {
        trait: "design",
        type: "string",
        values: ["Portal Prologue", "La Vista", "X Essence"],
      },
      {
        trait: "color",
        type: "string",
  ...
  static async walletPhraseDecode(phrase: string, path: string): Promise<any> {
    try {
      const command: CommandInterface = new WalletPhraseDecodeCommand(
        phrase,
        path
      );
      return command.run();
  ...
  async serverVersion(): Promise<CommandResultInterface> {
    try {
      ...
      const command: CommandInterface = new ServerVersionCommand(
        this.electrumApi
      );
      return await command.run();
    } catch (error: any) {
  ...
  async mintDatInteractive(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new MintInteractiveDatCommand(
        this.electrumApi,
        options,
        filepath,
        givenFileName,
  ...
  async mintNftInteractive(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new MintInteractiveNftCommand(
        this.electrumApi,
        options,
        files,
        address,
  ...
  async mintSubrealmInteractive(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new MintInteractiveSubrealmCommand(
        this.electrumApi,
        options,
        requestSubRealm,
        address,
  ...
  async mintContainerItemInteractive(
    options: BaseRequestOptions,
    container: string,
    itemId: string,
    manifestFile: string,
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new MintInteractiveDitemCommand(
        this.electrumApi,
        options,
        container,
        itemId,
  ...
  async mintContainerInteractive(
    options: BaseRequestOptions,
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new MintInteractiveContainerCommand(
        this.electrumApi,
        options,
        requestContainer,
        address,
  ...
  async mintFtInteractive(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new MintInteractiveFtCommand(
        this.electrumApi,
        options,
        file,
        supply,
  ...
  async mintDftInteractive(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new MintInteractiveDftCommand(
        this.electrumApi,
        options,
        address,
        ticker,
  ...
  async initDftInteractive(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new InitInteractiveDftCommand(
        this.electrumApi,
        options,
        file,
        address,
  ...
  async disableSubrealmRules(
    options: BaseRequestOptions,
    realmOrSubrealm: string,
    funding: IWalletRecord,
    atomicalOwner: IWalletRecord
  ): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface =
        new DisableSubrealmRulesInteractiveCommand(
          this.electrumApi,
          options,
          realmOrSubrealm,
          funding,
  ...
  async enableSubrealmRules(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new EnableSubrealmRulesCommand(
        this.electrumApi,
        options,
        realmOrSubrealm,
        file,
  ...
  async setRelationInteractive(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new SetRelationInteractiveCommand(
        this.electrumApi,
        options,
        atomicalId,
        relationName,
  ...
  async splatInteractive(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new SplatInteractiveCommand(
        this.electrumApi,
        options,
        atomicalId,
        atomicalOwner,
  ...
  async splitItneractive(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new SplitInteractiveCommand(
        this.electrumApi,
        options,
        atomicalId,
        atomicalOwner,
  ...
  async emitInteractive(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new EmitInteractiveCommand(
        this.electrumApi,
        options,
        atomicalId,
        files,
  ...
  async setInteractive(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new SetInteractiveCommand(
        this.electrumApi,
        options,
        atomicalId,
        filename,
  ...
  async setContainerDataInteractive(
    options: BaseRequestOptions,
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new SetContainerDataInteractiveCommand(
        this.electrumApi,
        options,
        containerName,
        filename,
  ...
  async setContainerDmintInteractive(
    options: BaseRequestOptions,
    containerName: string,
    filename: string,
    funding: IWalletRecord,
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new SetContainerDmintInteractiveCommand(
        this.electrumApi,
        options,
        containerName,
        filename,
  ...
  async deleteInteractive(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new DeleteInteractiveCommand(
        this.electrumApi,
        options,
        atomicalId,
        filesToDelete,
  ...
  async sealInteractive(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new SealInteractiveCommand(
        this.electrumApi,
        options,
        atomicalId,
        atomicalOwner,
  ...
  async transferInteractiveFt(
    options: BaseRequestOptions,
    atomicalId: string,
    owner: IWalletRecord,
    funding: IWalletRecord,
    validatedWalletInfo: IValidatedWalletInfo,
    satsbyte: number,
    nofunding: boolean,
    atomicalIdReceipt?: string
  ): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
  ...
  async transferInteractiveBuilder(
    options: BaseRequestOptions,
    owner: IWalletRecord,
    funding: IWalletRecord,
    validatedWalletInfo: IValidatedWalletInfo,
  ...
  async transferInteractiveUtxos(
    options: BaseRequestOptions,
    owner: IWalletRecord,
    funding: IWalletRecord,
    validatedWalletInfo: IValidatedWalletInfo,
  ...
  async global(
    hashes = 10,
    keepElectrumAlive = false
  ): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new GetGlobalCommand(
        this.electrumApi,
        hashes
      );
      return await command.run();
  ...
  async resolveAtomical(
    atomicalIdOrNumberOrVariousName: string,
    atomicalsGetFetchType: AtomicalsGetFetchType,
    verbose = false,
    keepElectrumAlive = false
  ): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new ResolveCommand(
        this.electrumApi,
        atomicalIdOrNumberOrVariousName,
        atomicalsGetFetchType,
        verbose
      );
      return await command.run();
  ...
  async getRealmInfo(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new GetRealmInfoCommand(
        this.electrumApi,
        atomicalIdOrNumberOrVariousName,
        verbose
      );
  ...
  async getAtomical(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new GetCommand(
        this.electrumApi,
        atomicalAliasOrId
      );
      return await command.run();
  ...
  async getAtomicalFtInfo(
    atomicalAliasOrId: string,
    keepElectrumAlive = false
  ): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new GetFtInfoCommand(
        this.electrumApi,
        atomicalAliasOrId
      );
      return await command.run();
  ...
  async searchTickers(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new SearchTickersCommand(
        this.electrumApi,
        prefix,
        asc
      );
  ...
  async searchContainers(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new SearchContainersCommand(
        this.electrumApi,
        prefix,
        asc
      );
  ...
  async searchRealms(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new SearchRealmsCommand(
        this.electrumApi,
        prefix,
        asc
      );
  ...
  async getAtomicalByRealm(
    realm: string,
    keepElectrumAlive = false
  ): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new GetByRealmCommand(
        this.electrumApi,
        realm
      );
      return await command.run();
  ...
  async getAtomicalByTicker(
    ticker: string,
    keepElectrumAlive = false
  ): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new GetByTickerCommand(
        this.electrumApi,
        ticker
      );
      return await command.run();
  ...
  async getAtomicalByContainer(
    container: string,
    keepElectrumAlive = false
  ): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new GetByContainerCommand(
        this.electrumApi,
        container
      );
      return await command.run();
  ...
  async getContainerItems(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new GetContainerItems(
        this.electrumApi,
        container,
        limit,
        offset
  ...
  async getAtomicalByContainerItem(
    container: string,
    itemId: string,
    keepElectrumAlive = false
  ): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new GetContainerItemCommand(
        this.electrumApi,
        container,
        itemId
      );
  ...
  async getAtomicalByContainerItemValidated(
    container: string,
    itemId: string,
    manifestFile: string
  ): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface =
        new GetContainerItemValidatedByManifestCommand(
          this.electrumApi,
          container,
          itemId,
          manifestFile
  ...
  async addressInfo(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new AddressInfoCommand(
        this.electrumApi,
        address,
        verbose
      );
  ...
  async pendingSubrealms(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new PendingSubrealmsCommand(
        this.electrumApi,
        options,
        address,
        funding.WIF,
  ...
  async summarySubrealms(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new SummarySubrealmsCommand(
        this.electrumApi,
        address,
        filter
      );
  ...
  async summaryContainers(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new SummaryContainersCommand(
        this.electrumApi,
        address,
        filter
      );
  ...
  async summaryRealms(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new SummaryRealmsCommand(
        this.electrumApi,
        address,
        filter
      );
  ...
  async summaryTickers(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new SummaryTickersCommand(
        this.electrumApi,
        address,
        filter
      );
  ...
  async walletInfo(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new WalletInfoCommand(
        this.electrumApi,
        address,
        verbose
      );
  ...
  async list(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new ListCommand(
        this.electrumApi,
        offset,
        limit,
        asc
  ...
  async getUtxos(
    ...
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new GetUtxosCommand(
        this.electrumApi,
        address
      );
      return await command.run();
  ...
  async getHistory(address: string): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new AddressHistoryCommand(
        this.electrumApi,
        address
      );
      return await command.run();
  ...
  async getAtomicals(address: string): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new GetAtomicalsAddressCommand(
        this.electrumApi,
        address
      );
      return await command.run();
  ...
  async getTx(txid: string, verbose: boolean): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new TxCommand(
        this.electrumApi,
        txid,
        verbose
      );
  ...
  async download(locationIdOrTxId: string): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new DownloadCommand(
        this.electrumApi,
        locationIdOrTxId
      );
      return await command.run();
  ...
  async broadcast(rawtx: string): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new BroadcastCommand(
        this.electrumApi,
        rawtx
      );
      return await command.run();
  ...
  async getAtomicalsAtLocation(
    location: string
  ): Promise<CommandResultInterface> {
    try {
      await this.electrumApi.open();
      const command: CommandInterface = new GetAtomicalsAtLocationCommand(
        this.electrumApi,
        location
      );
      return await command.run();
...
try {
  ...
  console.log(
    "atomicals window object not found. Skipping initialization on window object"
  );
}
